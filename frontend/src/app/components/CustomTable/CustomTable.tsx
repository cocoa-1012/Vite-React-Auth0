...
function CustomTable({ data, isEdit }: { data: DataType[], isEdit: boolean }) {
    ...
    <div className=' bg-table p-4 rounded-xl'>
      <div className='flow-root'>
        <div className='-mx-2 -my-2 overflow-x-auto sm:-mx-2 lg:-mx-8'>
          <div className='inline-block min-w-full max-h-[500px] align-middle sm:px-6 lg:px-8 scrollbar-hide'>
